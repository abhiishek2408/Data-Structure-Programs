...
public class _10_PermutationsWithoutConsecutiveVowels {
    ...
    public static void main(String[] args) {
        String str = "AEIOU";
        _10_PermutationsWithoutConsecutiveVowels permutations = new _10_PermutationsWithoutConsecutiveVowels();
