...
public class _10_AddRemoveListEdgeUnDirected {
    private List<List<Integer>> adjList;

    public _10_AddRemoveListEdgeUnDirected(int vertices) {
    ...
    public static void main(String[] args) {
        ...
        _10_AddRemoveListEdgeUnDirected graph = new _10_AddRemoveListEdgeUnDirected(3); // Start with 3 vertices
