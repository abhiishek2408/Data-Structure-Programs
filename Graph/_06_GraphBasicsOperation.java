...
public class _06_GraphBasicsOperation {

    private int[][] adjMatrix;
    private int vertices;

    public _06_GraphBasicsOperation(int vertices) {
    ...
    public static void main(String[] args) {
        ...
        _06_GraphBasicsOperation graph = new _06_GraphBasicsOperation(3); // Start with 3 vertices
