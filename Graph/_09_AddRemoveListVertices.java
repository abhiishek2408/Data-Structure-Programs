...
public class _09_AddRemoveListVertices {

    private List<List<Integer>> adjList;

    public _09_AddRemoveListVertices(int vertices) {
    ...
    public static void main(String[] args) {
        ...
        _09_AddRemoveListVertices graph = new _09_AddRemoveListVertices(3); // Start with 3 vertices
