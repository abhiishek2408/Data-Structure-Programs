...
public class _12_CheckAdjVerticesMatrix {
    private int[][] adjMatrix;
    private int vertices;

    public _12_CheckAdjVerticesMatrix(int vertices) {
    ...
    public static void main(String[] args) {
        ...
        _12_CheckAdjVerticesMatrix graph = new _12_CheckAdjVerticesMatrix(vertices);
