...
public class _14_FindAdjVerticesMatrix {
    private int[][] adjMatrix;
    private int vertices;

    public _14_FindAdjVerticesMatrix(int vertices) {
    ...
    public static void main(String[] args) {
        ...
        _14_FindAdjVerticesMatrix graph = new _14_FindAdjVerticesMatrix(vertices);
