...
public class _15_FindAdjVerticesList {
    private List<List<Integer>> adjList;

    public _15_FindAdjVerticesList(int vertices) {
    ...
    public static void main(String[] args) {
        ...
        _15_FindAdjVerticesList graph = new _15_FindAdjVerticesList(5); // Start with 5 vertices
