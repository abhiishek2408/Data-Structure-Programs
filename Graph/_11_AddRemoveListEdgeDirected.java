...
public class _11_AddRemoveListEdgeDirected {
    private List<List<Integer>> adjList; // Adjacency list

    public _11_AddRemoveListEdgeDirected(int vertices) {
    ...
    public static void main(String[] args) {
        _11_AddRemoveListEdgeDirected graph = new _11_AddRemoveListEdgeDirected(5); // Creating a graph with 5 vertices
