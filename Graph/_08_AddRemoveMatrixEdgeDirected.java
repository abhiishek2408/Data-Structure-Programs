...
public class _08_AddRemoveMatrixEdgeDirected {

    private int[][] adjMatrix;
    private int vertices;

    public _08_AddRemoveMatrixEdgeDirected(int vertices) {
    ...
    public static void main(String[] args) {
        ...
        _08_AddRemoveMatrixEdgeDirected graph = new _08_AddRemoveMatrixEdgeDirected(vertices);
