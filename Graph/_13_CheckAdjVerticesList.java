...
public class _13_CheckAdjVerticesList {

    private List<List<Integer>> adjList;

    public _13_CheckAdjVerticesList(int vertices) {
    ...
    public static void main(String[] args) {
        ...
        _13_CheckAdjVerticesList graph = new _13_CheckAdjVerticesList(4); // Start with 4 vertices
