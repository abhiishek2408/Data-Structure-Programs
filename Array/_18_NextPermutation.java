...
public class _18_NextPermutation {
    ...
    public static void main(String[] args) {
        _18_NextPermutation solution = new _18_NextPermutation();
        int[] nums = {1, 2, 3};
...
//explanation:
// This code defines a public class _18_NextPermutation that contains a method to compute the next lexicographical permutation of an array of integers.
