...
public class _37_Sum_Of_Subarray_Maximums {
    ...
    public static void main(String[] args) {
        _37_Sum_Of_Subarray_Maximums solution = new _37_Sum_Of_Subarray_Maximums();

        // Example array
        int[] nums = {3, 1, 4, 2};

        // Calculate and print the maximum subarray contribution sum
        long result = solution.getMaxContribution(nums);
